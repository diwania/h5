# 【20250327 更新】Privacy Policy-Diwania

#### **Date of Last Revision: ****March 27****,**** ****2025**
...
C.  Sharing Personal Information with Business Partners When Necessary:

You understand and acknowledge that, in order to provide you with more comprehensive and high-quality products and services, we may authorize business partners to offer certain services on our behalf. In such cases, we may share certain personal information with these partners to enhance customer service and user experience. Please note that we will only share your personal information for legitimate, appropriate, necessary, specific, and explicit purposes, and only to the extent required for the services being provided. We will conduct security assessments and implement safeguards to ensure the secure output, transmission, and use of the data. Furthermore, we will strictly monitor and manage our partners, and if any violations in the handling of personal information are detected, we will immediately terminate the partnership and pursue legal responsibility.

D. Instances where we are required to disclose your information. We will disclose your information where required to do so by law, if subject to court orders or other legal proceeding or if we reasonably believe that such action is necessary to (a) comply with the law and the reasonable requests of law enforcement; (b) to comply with a legal obligation; © to protect the personal safety of users of the Services or the public; (d) to enforce our Terms or to protect the security or integrity of our Service; and/or (e) to protect and defend the legitimate rights or property of the Company, Related Companies, our users or other persons.
